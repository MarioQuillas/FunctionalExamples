...
namespace DddInPractice.Logic.SharedKernel
{
    public sealed class Money : ValueObject<Money>
    {
        ...
        public decimal Amount => OneCentCount * 0.01m + TenCentCount * 0.10m + QuarterCount * 0.25m
                                 + OneDollarCount + FiveDollarCount * 5 + TwentyDollarCount * 20;
        ...
        {
            if (Amount < 1) return "¢" + (Amount * 100).ToString("0");
